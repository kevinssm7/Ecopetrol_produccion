...
namespace Facede
{
    public class Facade
    {
        ...
        public management_planMejoraDispensacion_evaluacionIdResult PlanMejoraEvaluacionDispenId(int? idEvaluacion)
        {
            return DACConsulta.PlanMejoraEvaluacionDispenId(idEvaluacion);
        }
        ...
        {
            return DACActualiza.ActualizarEstadoPM(idPlan, estado);
        }
        ...
        public List<management_plan_mejora_tableroResult> PlanTableroGeneral(int? idEva, DateTime? fechaIni, DateTime? fechaFin, string regional, string nit)
        {
            return DACConsulta.PlanTableroGeneral(idEva, fechaIni, fechaFin, regional, nit);
        }
        ...
        public int ActualizarVisitaDispensacionCreacionPM(int? idEvaluacion, int? idPlan)
        {
            return DACActualiza.ActualizarVisitaDispensacionCreacionPM(idEvaluacion, idPlan);
        }
    ...
    string documentoPaciente, int? idConcurrencia, DateTime? fechaIngresoIni, DateTime? fechaIngresoFin, int? conEgreso)
        ...
        public int ActualizarPuntoDispensacion(ver_puntoDispensacion obj, int motivo)
        {
            return DACActualiza.ActualizarPuntoDispensacion(obj, motivo);
        }


        public int EliminarCancelarVisitasDispen(ver_puntoDispensacion obj)
        {
            return DACActualiza.EliminarCancelarVisitasDispen(obj);
        }
        ...
        public int InsertarActaEvaluacion(ver_dispen_evaluacion_acta obj)
        {
            return DACInserta.InsertarActaEvaluacion(obj);
        }


        public int InsertarInstrumentoVerificacionEvaluacion(ver_dispen_evaluacion_instrumentoVerificacion obj)
        {
            return DACInserta.InsertarInstrumentoVerificacionEvaluacion(obj);
        }

        public ver_dispen_evaluacion_acta ConsultarArchivoActaEvaluacion(int? idEvaluacion)
        {
            return DACConsulta.ConsultarArchivoActaEvaluacion(idEvaluacion);
        }

        public int EliminarArchivoActaEvaluacion(int? idEvaluacion)
        {
            return DACElimina.EliminarArchivoActaEvaluacion(idEvaluacion);
        }

        public int InsertarLogEliminadoArchivosEvaluacionDispen(log_ver_dispen_evaluacion_eliminarActaInforme obj)
        {
            return DACInserta.InsertarLogEliminadoArchivosEvaluacionDispen(obj);
        }

        public ver_dispen_evaluacion_instrumentoVerificacion ConsultarArchivoInsVerifiacionEvaluacionDispen(int? idEvaluacion)
        {
            return DACConsulta.ConsultarArchivoInsVerifiacionEvaluacionDispen(idEvaluacion);
        }

        public int EliminarArchivoInstrumentoVerificacionEvaluacion(int? idEvaluacion)
        {
            return DACElimina.EliminarArchivoInstrumentoVerificacionEvaluacion(idEvaluacion);
        }

        public int ActualizarDescripcionDetallesEvaluacion(int? idEvaluacion)
        {
            return DACActualiza.ActualizarDescripcionDetallesEvaluacion(idEvaluacion);
        }

        public List<ref_puntoDispensacion_tiposActualizacion> TraerTiposActualizarVisita()
        {
            return DACConsulta.TraerTiposActualizarVisita();
        }

        public List<ref_puntoDispensacion_tiposNovedad> TraerTiposNovedadVisita()
        {
            return DACConsulta.TraerTiposNovedadVisita();
        }

        public int InsertarNovedadVisitaDispensacion(ver_puntoDispensacion_novedades obj)
        {
            return DACInserta.InsertarNovedadVisitaDispensacion(obj);
        }

        public int InsertarActualizacionVisitasDispen(ver_puntoDispensacion_actualizaciones obj)
        {
            return DACInserta.InsertarActualizacionVisitasDispen(obj);
        }

        public List<management_dispensacion_evaluacionRelacion_total_IdEvaluacionResult> getDispensacionEvaluacionTotalIdEvaluacion(int? idEvaluacion)
        {
            return DACConsulta.getDispensacionEvaluacionTotalIdEvaluacion(idEvaluacion);
        }

        public ver_dispen_evaluacion TarerDatosEvaluacionId(int? idPunto)
        {
            return DACConsulta.TarerDatosEvaluacionId(idPunto);
        }
        #endregion
        ...
        public List<management_fis_rips_ParaActualizar_tigasResult> TraerListadoCUPSActualziarTigas(int? idAf,
            DateTime? fechaIni, DateTime? fechaFin, string codPrestador, string numFactura)
        {
            return DACConsulta.TraerListadoCUPSActualziarTigas(idAf, fechaIni, fechaFin, codPrestador, numFactura);
        }
        ...
        public List<management_fis_reporteHes_sinReglasResult> TraerDatosReporteHESSR(DateTime? fechaIni, DateTime? fechaFin, string regional)
        {
            return DACConsulta.TraerDatosReporteHESSR(fechaIni, fechaFin, regional);
        }
