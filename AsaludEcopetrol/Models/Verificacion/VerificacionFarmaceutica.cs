...
namespace AsaludEcopetrol.Models.Verificacion
{
    public class VerificacionFarmaceutica
    {
        ...
        {
            return BusClass.ActualizarPuntoDispensacion(obj, motivo);
        }


        public int EliminarCancelarVisitasDispen(ver_puntoDispensacion obj)
        {
            return BusClass.EliminarCancelarVisitasDispen(obj);
        }
        ...
        {
            return BusClass.getDispensacionEvaluacionTotalIdEvaluacion(idEvaluacion);
        }
    }
}