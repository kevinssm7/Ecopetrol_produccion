                ...
                if (ConsultaE != null)
                {
                    ...
                    try
                    {
                        ...
                        if (texto.Length <= 13)
                        {
                            ...
                            if (cups == null)
                            {
                                textError = $"{ columna} , no existe CUPS {dato.codConsulta} en tabla de CUPS.";
                            }
                            else
                            {
                                dato.codConsulta = codigoLimpio;
                            }
                        }
                        else
                        {
        ...
        public fis_rips_cargue_procedimientos ValidarEstructuraProcedimiento(JObject ProcedimientoE, string codPrestador, List<fis_rips_cups> listadoCups, int? fila)
        {
            ...
            try
            {
                ...
                if (texto.Length <= 100)
                {
                    ...
                    if (cups == null)
                    {
                        textError = $"{ columna} , no existe CUPS {dato.codProcedimiento} en tabla de CUPS.";
                    }
                    else
                    {
                        dato.codProcedimiento = codigoLimpio;
                    }
                }
                else
                {
        ...
        public fis_rips_cargue_medicamentos ValidarEstructuraMedicamento(JObject MedicamentoE, string codPrestador, List<fis_rips_cups> listadoCups, int? fila)
        {
            ...
            try
            {
                ...
                if (texto.Length <= 50)
                {
                    ...
                    if (cups == null)
                    {
                        textError = $"{ columna} , no existe CUPS {dato.codTecnologiaSalud} en tabla de CUPS.";
                    }
                    else
                    {
                        dato.codTecnologiaSalud = codigoLimpio;
                    }
                }
                else
                {
                        ...
                        if (!string.IsNullOrEmpty(item["ID_detalle"].ToString()))
                        {
                            ...
                            try
                            {
                                ...
                                if (!string.IsNullOrEmpty(texto))
                                {
                                    ...
                                    if (cups == null)
                                    {
                                        textError = $"{ columna} , no existe CUPS {obj.cups_homologado} en tabla de CUPS.";
                                    }
                                    else
                                    {
                                        obj.cups_homologado = codigoLimpio;
                                    }
                                }
                                else
                                {
