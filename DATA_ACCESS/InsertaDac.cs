    ...
    public class InsertaDac
    {
        ...
        public int InsertarActaEvaluacion(ver_dispen_evaluacion_acta obj)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.ver_dispen_evaluacion_acta.InsertOnSubmit(obj);
                    db.SubmitChanges();
                    return obj.id_archivo;
                }
            }
        ...
        public int InsertarInstrumentoVerificacionEvaluacion(ver_dispen_evaluacion_instrumentoVerificacion obj)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.ver_dispen_evaluacion_instrumentoVerificacion.InsertOnSubmit(obj);
                    db.SubmitChanges();
                    return obj.id_archivo;
                }
            }
        ...
        public int InsertarLogEliminadoArchivosEvaluacionDispen(log_ver_dispen_evaluacion_eliminarActaInforme obj)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.log_ver_dispen_evaluacion_eliminarActaInforme.InsertOnSubmit(obj);
                    db.SubmitChanges();
                    return obj.id_log;
                }
            }
        ...
        public int InsertarNovedadVisitaDispensacion(ver_puntoDispensacion_novedades obj)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.ver_puntoDispensacion_novedades.InsertOnSubmit(obj);
                    db.SubmitChanges();
        ...
        public int InsertarActualizacionVisitasDispen(ver_puntoDispensacion_actualizaciones obj)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    db.ver_puntoDispensacion_actualizaciones.InsertOnSubmit(obj);
                    db.SubmitChanges();
                    return obj.id_actualizacion;
                }
            }
