    ...
    public class EliminaDac
    {
        ...
        public int EliminarArchivoActaEvaluacion(int? idEvaluacion)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    ver_dispen_evaluacion_acta obj = db.ver_dispen_evaluacion_acta.FirstOrDefault(x => x.id_evaluacion == idEvaluacion);
                    db.ver_dispen_evaluacion_acta.DeleteOnSubmit(obj);
                    db.SubmitChanges();
                    return 1;
                }
            }
        ...
        public int EliminarArchivoInstrumentoVerificacionEvaluacion(int? idEvaluacion)
        {
            try
            {
                using (ECOPETROL_DataContexDataContext db = new ECOPETROL_DataContexDataContext())
                {
                    ver_dispen_evaluacion_instrumentoVerificacion obj = db.ver_dispen_evaluacion_instrumentoVerificacion.FirstOrDefault(x => x.id_evaluacion == idEvaluacion);
                    db.ver_dispen_evaluacion_instrumentoVerificacion.DeleteOnSubmit(obj);
                    db.SubmitChanges();
                    return 1;
                }
            }
